...
<div class="top">
  ...
  <span>Dream项目管理系统 var2.0</span></div>
 <div class="content">
   <div>
     <br/>
     <h3 align="center">中文版授权协议 适用于中文用户</h3>
     <p>&nbsp;&nbsp;&nbsp; 版权所有 (c) 2010-2014，梦赢科技保留所有权利。</p>
     <p>&nbsp;&nbsp;&nbsp; 感谢您选择 Dream项目管理系统 产品。希望我们的努力能为您提供一个高效快速和强大的权限管理解决方案，节省开发时间与成本，免去重复开发，让您能立即进入关键项目功能的开发。</p>
     <p>&nbsp;&nbsp;&nbsp; 梦赢科技为 Dream项目管理系统 产品的开发商，依法独立拥有 Dream项目管理系统 产品著作权。梦赢科技网址为   http://www.d-winner.com，Dream项目管理系统官方网站网址为 http://www.d-winner.com，Dream项目管理系统官方讨论区网址为   http://bbs.d-winner.com。</p>
     <p>&nbsp;&nbsp;&nbsp; Dream项目管理系统   著作权已在中华人民共和国国家版权局注册，著作权受到法律和国际公约保护。使用者：无论个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，在理解、同意、并遵守本协议的全部条款后，方可开始使用 Dream项目管理系统。</p>
     <p>&nbsp;&nbsp;&nbsp; 本授权协议适用且仅适用于 Dream项目管理系统 1.x 版本，梦赢科技拥有对本授权协议的最终解释权。</p>
     <h4>I. 协议许可的权利</h4>
     <ol>
       <li>您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。 </li>
       <li>您可以在协议规定的约束和限制范围内修改 Dream项目管理系统 源代码(如果被提供的话)或界面风格以适应您的WEB应用要求。 </li>
     ...
     <h4>II. 协议规定的约束和限制</h4>
     <ol>
       <li>未获商业授权之前，不得将本软件用于商业用途（包括但不限于企业网站、经营性网站、以营利为目或实现盈利的网站）。购买商业授权请登陆http://www.d-winner.com参考相关说明。 </li>
       <li>不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。 </li>
       <li>无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用 Dream项目管理系统 的整体或任何部分，未经书面许可，页面页脚处的 Dream项目管理系统  名称和梦赢科技官方网站（http://www.d-winner.com） 的链接都必须保留，而不能清除或修改。 </li>
       <li>禁止在 Dream项目管理系统 的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。 </li>
     ...
     <ol>
       ...
       <li>梦赢科技不对使用本软件构建的网站中的文章或信息承担责任。 </li>
     </ol>
     <p>&nbsp;&nbsp;&nbsp; 有关 Dream项目管理系统 最终用户授权协议、商业授权与技术服务的详细内容，均由 Dream项目管理系统   官方网站独家提供。梦赢科技拥有在不事先通知的情况下，修改授权协议和服务价目表的权力，修改后的协议或价目表对自改变之日起的新授权用户生效。</p>
