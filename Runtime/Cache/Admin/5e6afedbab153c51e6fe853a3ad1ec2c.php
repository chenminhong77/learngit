<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><html><head><meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8" content="ie=edge" /><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>Dream项目管理系统 - <?php echo C('CFG_NAME') ?></title><link  id="easySty" rel="stylesheet" type="text/css" href="__ITEM__/__UI__/themes/default/easyui.css"><link type="text/css" rel="stylesheet" href="__ITEM__/__ADMIN.CSS__/index.css"><link id="adminSty" type="text/css" rel="stylesheet" href="__ITEM__/__ADMIN.CSS__/default/style.css"><link rel="stylesheet" type="text/css" href="__ITEM__/__UI__/themes/icon.css"><link rel="stylesheet" href="__ITEM__/__JS__/kindeditor/themes/default/default.css" /><link rel="stylesheet"  href="__ITEM__/__JS__/datepicker/skin/default/datepicker.css"><script type="text/javascript" src="__ITEM__/__JS__/datepicker/WdatePicker.js"></script><script charset="utf-8" src="__ITEM__/__JS__/kindeditor/kindeditor-min.js"></script><script charset="utf-8" src="__ITEM__/__JS__/kindeditor/lang/zh_CN.js"></script><script type="text/javascript" src="__ITEM__/__UI__/jquery.js"></script><script type="text/javascript" src="__ITEM__/__JS__/jquery.cookie.js"></script><script type="text/javascript" src="__ITEM__/__UI__/jquery.easyui.min.js"></script><script type="text/javascript" src="__ITEM__/__UI__/locale/easyui-lang-zh_CN.js"></script><script type="text/javascript" src="__ITEM__/__UI__/plugins/jquery.kindeditor.js"></script><script type="text/javascript" src="__ITEM__/__UI__/plugins/jquery.datepicker.js"></script><script type="text/javascript" src="__ITEM__/__UI__/view/datagrid-scrollview.js"></script><script type="text/javascript" src="__ITEM__/__UI__/view/datagrid-bufferview.js"></script><script type="text/javascript" src="__ITEM__/__JS__/objFunc.js"></script><script type="text/javascript" src="__ITEM__/__JS__/getPinYin.js"></script><script type="text/javascript" src="__ITEM__/__JS__/objClass.js"></script><script type="text/javascript" src="__ITEM__/__JS__/acrossClass.js"></script><script charset="utf-8" src="__ITEM__/__JS__/kindeditor/plugins/image/image.js"></script><script language="javascript"> var cancel = new Array();
 ...
 function toRepwd(){
	 $(function(){
		...
		$("#repwd").dialog({
			...
			width:400,
			height:225,
			href:'__APP__?g=<?php echo GROUP_NAME; ?>&m=User&a=repwd&id='+idd,
			onOpen:function(){
				cancel['Repwd'] = $(this);
			},
		});	 
 ...
 function toShowSms(){
	 $(function(){
		$("#setpwd").dialog({
			...
			width:580,
			height:353,
			href:'__APP__?g=<?php echo GROUP_NAME; ?>&m=User&a=showsms&act=1',
			onOpen:function(){
				cancel['Sendsms'] = $(this);
			},
			onClose:function(){
 ...
 function toSetpwd(){
	 $(function(){
		...
		$("#setpwd").dialog({
			...
			width:450,
			height:250,
			href:'__APP__?g=<?php echo GROUP_NAME; ?>&m=User&a=setpwd&id='+idd,
			onOpen:function(){
				cancel['Setpwd'] = $(this);
			},
		});	 
 ...
 function toSendMail(){
	...
	$("<div />").dialog({
		...
		width:900,
		height:435,
		href:'__APP__?g=Public&m=Mail&a=index&mode=1&id='+idd,
		onOpen:function(){
 ...
 function toClearCache(){
	 $(function(){
		$.get('__APP__?g=<?php echo GROUP_NAME; ?>&m=Index&a=cache', function(data){
			$.messager.alert('提示','所有临时、JSON等缓存文件已被清除！','info');
		}); 
 ...
 $(function(){
	...
	if(isskin){
		...
		$("#logoImg").attr("src","__ITEM__/__ADMIN.CSS__/"+isskin+"/logo.png");
	...
	+"<div class='skin-list' id='grinder' title='土黄色'><div class='skin-color' id='grinderBg'></div></div>"
	...
	$.get('__URL__/getsms',function(data){
		if(data>0){
			$("#smsid").addClass("sms");
			$("#smsid").html(data);
			$("#smsid").attr("title","您有"+data+"条未读信息");
		}else{
			$("#smsid").removeClass("sms");
			$("#smsid").html("");
			$("#smsid").attr("title","");
		}
	});
...
</script><div class="logo"><img id="logoImg" src="__ITEM__/__ADMIN.CSS__/default/logo.png" /></div><div class="show"><div class="l2"><span id="localtime" style="margin-right:18px"></span><a style="vertical-align:middle;" href="#" id="chgSkin" title="切换皮肤"><img src="__ITEM__/__IMG__/skin.png" /></a><span class="hi">你好：<strong><?php echo $_SESSION['login']['se_user'] ?></strong><span id="smsid" style="cursor:pointer;" onclick="toShowSms()"></span> - <?php echo $_SESSION['login']['se_group'] ?> &nbsp;[<a href="javascript:toSendMail();">发邮件</a>] <?php if($group_access>=9999){ ?>[<a href="javascript:toClearCache();">清除缓存</a>]<?php } ?> [<a href="javascript:toRepwd();">修改密码</a>] [<a href="javascript:toSetpwd();">邮箱设置</a>] [<a href="http://bbs.d-winner.com/" target="_blank">帮助</a>] [<a target="_top" href="__APP__?g=<?php echo GROUP_NAME; ?>&m=Index&a=safe">注销</a>] </span></div></div><script runat="server" language="javascript">function tick(){  
    var today;  
    today = new Date();
...
</script><div id="leftMenu" data-options="fit:true,border:false" class="easyui-accordion"><?php if(is_array($info)): foreach($info as $key=>$t): if($t['mode']==1){ $access = IndexPublic::GS('User_group_table',$gid); }elseif($t['mode']==2){ $access = IndexPublic::GS('User_company_table',$cid); }elseif($t['mode']==3){ $access = IndexPublic::GS('User_part_table',$pid); } if($t['type']=='='){ $view = unserialize($t['view']); if(strstr($t['level'],$access) || ($group_access>=999 && $t['level']<9999) || in_array($uid,$view)){ ?><div title="<?php echo ($t["text"]); ?>" data-options="iconCls:'<?php echo ($t["iconCls"]); ?>'"><ul class="easyui-tree left-tree" data-options="url:'__APP__?g=<?php echo GROUP_NAME; ?>&m=Index&a=json&mid=<?php echo ($t["id"]); ?>',editable:false,lines:true,method:'get',onClick:function(node){onClickTree(node);}"></ul></div><?php
 } }else{ $view = unserialize($t['view']); if($access>=$t['level'] || in_array($uid,$view)){ ?><div title="<?php echo ($t["text"]); ?>" data-options="iconCls:'<?php echo ($t["iconCls"]); ?>'"><ul class="easyui-tree left-tree" data-options="url:'__APP__?g=<?php echo GROUP_NAME; ?>&m=Index&a=json&mid=<?php echo ($t["id"]); ?>',editable:false,lines:true,method:'get',onClick:function(node){onClickTree(node);}"></ul></div><?php
 } } endforeach; endif; ?><!--
 <div title="系统管理" data-options="iconCls:'icon-setting'"><ul class="easyui-tree left-tree",editable:false,lines:true"><li data-options="text:'菜单管理',url:'__APP__?g=<?php echo GROUP_NAME; ?>&m=Menu&a=index'">菜单管理</li></ul></div>--></div></div><div data-options="region:'center',split:true"><div id="rightTabs" class="easyui-tabs" data-options="fit:true,border:false"><?php if($type==1){ ?><div title="最新跟进" data-options="closable:false,id:-3,href:'__APP__?g=<?php echo GROUP_NAME; ?>&m=<?php echo MODULE_NAME; ?>&a=myview'"></div><?php }else{ ?><div title="控制台" data-options="closable:false,id:-1,href:'__APP__?g=<?php echo GROUP_NAME; ?>&m=<?php echo MODULE_NAME; ?>&a=main'"></div><?php } ?></div></div><div id="repwd"></div><div id="setpwd"></div></body></html>